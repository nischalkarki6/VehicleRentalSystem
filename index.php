...
$homeCtrl = new HomeController($pdo);
$stats = $homeCtrl->getHomePageStats();
...
<main>
      ...
      <section class="legacy-section container">
        <div class="legacy-grid">
          <div class="legacy-text">
            ...
            <p>
              Founded in 2003, DriveEase is to be the top car rental company
            ...
            <div class="trusted-block">
              <div class="avatars">
                <div class="avatar bg-aebfd0"></div>
                <div class="avatar bg-4a5d7c"></div>
                <div class="avatar bg-1b263b"></div>
              </div>
          ...
          <div class="legacy-images">
            <img src="public/images/jeeeep.png" class="legacy-img-1" alt="Jeep SUV" />
            <img src="public/images/gallery-2.jpg" class="legacy-img-2" alt="Vintage Motorcycle Detail" />
          </div>
        </div>
      </section>
      ...
      <section class="how-it-works container">
        <div class="how-it-works-header">
          <h2>HOW IT WORKS.</h2>
          <p>Four simple steps to start your journey with DriveEase.</p>
        </div>
        <div class="steps-row">
          <div class="step">
            <div class="icon-box">
      ...
      <section class="urban-section container">
        <div class="urban-grid">
          <div class="urban-img-wrap">
            <img src="public/images/jeeeep.png" alt="Super SUV" class="urban-img" />
          </div>
